...
const HeroSection: React.FC<HeroSectionProps> = ({ player, onQuickAdd }) => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-football-primary via-football-secondary to-football-dark min-h-[400px] sm:min-h-[500px]">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <ModernCard className="p-4 sm:p-6 bg-white/95 backdrop-blur-xl border-0 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base sm:text-lg font-semibold text-gray-800">Season Overview</h3>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4">
                <div className="text-center">
                  <motion.div
                    className="text-2xl sm:text-3xl font-bold text-football-primary text-display"
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
            ...
            <ModernCard className="p-4 sm:p-6 bg-white/95 backdrop-blur-xl border-0 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base sm:text-lg font-semibold text-gray-800">Next Training</h3>
